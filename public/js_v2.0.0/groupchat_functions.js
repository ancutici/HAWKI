...
async function onSendMessageToRoom(inputField) {
    ...
    if(submittedObj.filteredContent.aiMention && submittedObj.filteredContent.aiMention.toLowerCase().includes('@gptalk')){
