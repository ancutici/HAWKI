...
<body>
	...
	<div class="wrapper">
		<div class="sidebar">
			<div class="logo">
				<img src="<?= $TEMPLATE_PATH ?>/img/universitaet-hohenheim-logo3.svg" alt="Universität Hohenheim Logo"
					width="150px">
			</div>
			<div class="menu">
				<details>
		...
		<div class="main">
			...
			<div class="limitations">
				...
				<div>
					...
					<div class="message me" data-role="system">
						<div class="message-content">
							...
							<div class="message-text">Du bist ein hilfsbereiter Assistent an der Universität Hohenheim.
							</div>
						</div>
					</div>
					...
					<div class="input">
						<div class="input-wrapper">
							<textarea class="input-field" type="text" placeholder="Hier kannst Du deine Anfrage stellen"
								oninput="resize(this),resize(document.getElementsByClassName('input-wrapper')[0])"
								onkeypress="handleKeydown(event)"></textarea>
						</div>
						<div class="input-send" onclick="OnSendClick()">
							<svg viewBox="2 2 21 21" width="80" height="80">
								<g fill="none" stroke="rgb(35, 48, 176)" stroke-width="2" stroke-linecap="round"
									stroke-linejoin="round" stroke="rgba(35, 48, 176)">
				...
				<div class="userpost-container">
					<div class="userpost">
						<textarea class="userpost-field" type="text"
							placeholder="Hier können Sie Ihr Feedback hinterlassen" oninput="resize(this)"
							onkeypress="handleKeydownUserPost(event)"></textarea>
		...
		<div class="modal" onclick="modalClick(this)" id="data-protection">
			<div class="modal-content">
				...
				<p>Bitte geben Sie keine personenbezogenen Daten ein. Wir verwenden die API von OpenAI. Das bedeutet,
					dass die von Ihnen eingegebenen Daten direkt an OpenAI gesendet werden. Es besteht die Möglichkeit,
					dass OpenAI diese Daten weiterverwendet.</p>
